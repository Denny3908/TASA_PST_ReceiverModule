...
def light_on(light, port):
    ...
    light.icheck1 = True
    light.serial_port.write(f"{"level 1 16"}\r\n".encode())  # 光源吃string指令
...
def capture_sequence():
    ...
    lineRate_seq = [1000, 1000, 1000, 600, 300, 300, 300]
    exposureTime_seq = [4, 30, 200, 1500, 3000, 3000, 3000]
    gain_seq = [1, 1, 1, 1, 1, 3.0, 10.0]
